  ...
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      <div className="relative w-full">
        ...
        >
          <div className="bg-white/70 backdrop-blur-md rounded-3xl px-10 py-10 max-w-2xl w-full mx-auto">
            ...
            <p className="text-[#0a1628]/60 text-base leading-relaxed mb-8 max-w-lg font-light">
