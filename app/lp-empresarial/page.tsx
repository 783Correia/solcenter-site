...
function LeadForm() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const msg = encodeURIComponent(
      `Olá! Me chamo ${name}, tenho uma empresa em ${city} e tenho interesse em energia solar empresarial. Nosso custo de energia atual é ${bill}. WhatsApp: ${phone}`
    );
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <select name="bill" required aria-label="Custo mensal de energia da empresa" className="glass-input">
        <option value="">Custo mensal de energia da empresa</option>
        <option value="entre R$1.000 e R$3.000">R$ 1.000 – R$ 3.000</option>
        <option value="entre R$3.000 e R$8.000">R$ 3.000 – R$ 8.000</option>
        <option value="entre R$8.000 e R$20.000">R$ 8.000 – R$ 20.000</option>
...
export default function LPEmpresarial() {
  ...
  return (
    <main className="min-h-screen font-sans antialiased">
      ...
      <section className="relative min-h-[100dvh] flex items-center overflow-hidden">
        <Image src="/images/solar-empresarial.webp" alt="Energia solar empresarial instalada pela Solcenter no RS" fill className="object-cover object-center" priority />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-14 py-24 lg:py-20 flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
          <div className="flex-1 flex flex-col justify-center">
            <div className="inline-flex items-center gap-2 bg-[#FFB100]/10 border border-[#FFB100]/25 rounded-full px-4 py-1.5 mb-6 w-fit">
              <Building2 size={13} className="text-[#FFB100]" />
              <span className="text-[#FFB100] text-xs font-bold tracking-wide">Energia solar para comércio e indústria no RS</span>
            </div>
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              <a href="#formulario"
                ...
                Análise gratuita para minha empresa <ArrowRight size={14} />
              </a>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2">
              {[
                ...
                { icon: Zap, label: "Instalação sem parar as operações" },
          ...
          <div id="formulario" className="w-full lg:w-[360px] shrink-0 glass-form-card rounded-2xl p-7">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-9 h-9 bg-[#FFB100]/15 rounded-xl flex items-center justify-center shrink-0">
                <Building2 size={16} className="text-[#FFB100]" />
              </div>
              <div>
                <h2 className="font-black text-white text-base leading-tight">Análise gratuita para empresas</h2>
      ...
      <div className="lp-warm relative">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2 relative rounded-3xl overflow-hidden h-72 md:h-auto min-h-[280px]">
                <Image src="/images/solar-empresarial.webp" alt="Energia solar empresarial" fill className="object-cover object-center" />
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end gap-6 mb-10">
              <div className="flex-1">
                ...
                <h2 className="text-[clamp(2rem,4vw,3.2rem)] font-black text-[#0a1628] leading-[1.05] tracking-tight">
                  Energia própria.<br />Custo sob controle.
                </h2>
              </div>
              <p className="md:max-w-xs text-gray-500 text-sm leading-relaxed md:mb-1">
                Resultados reais de empresas atendidas pela Solcenter no RS.
              </p>
            </div>
            ...
            <div className={`grid grid-cols-2 md:grid-cols-3 gap-4 transition-all duration-700 ${bentoInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              <div className="col-span-2 glass-light rounded-2xl p-7 flex flex-col justify-between min-h-[200px]">
                <p className="text-gray-400 text-xs font-medium mb-4 uppercase tracking-widest">Caso real — Comércio, RS</p>
                <div className="flex items-end gap-6 flex-wrap">
                  <div>
                    <p className="text-gray-400 text-xs mb-1">Antes</p>
                    <p className="text-4xl font-black text-red-400 line-through decoration-2">R$ 8.500</p>
                  ...
                  <div>
                    ...
                    <p className="text-4xl font-black text-green-600">R$ 620</p>
                    <p className="text-gray-400 text-xs mt-1">por mês</p>
                  </div>
                </div>
                <p className="text-gray-500 text-sm mt-5 leading-relaxed">
                  Empresa economiza <span className="text-[#0a1628] font-semibold">R$ 7.880 todo mês</span> — mais de <span className="text-[#FFB100] font-semibold">R$ 94.000 por ano</span>.
                </p>
              </div>
              ...
              <div className="col-span-2 relative rounded-2xl overflow-hidden h-52">
                <Image src="/images/solar-empresarial.webp" alt="Instalação Solcenter empresarial" fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute bottom-0 left-0 p-5">
                  <p className="text-white font-bold text-sm">Comércio, indústria e condomínios no RS</p>
              ...
              <div className="glass-light rounded-2xl p-6 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs leading-relaxed">Redução média no custo de energia dos clientes empresariais.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="como-funciona" className="relative px-6 py-16">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end gap-6 mb-14">
              <div className="flex-1">
                <p className="text-[#FFB100] text-xs font-bold uppercase tracking-[0.2em] mb-4">Do contrato à economia</p>
                <h2 className="text-[clamp(2rem,4vw,3.2rem)] font-black text-[#0a1628] leading-[1.05] tracking-tight">
                  4 passos.<br />Sem parar sua operação.
                </h2>
              </div>
              <p className="md:max-w-xs text-gray-500 text-sm leading-relaxed md:mb-1">
                A Solcenter cuida de todo o processo técnico e burocrático. Você continua focado no negócio.
              </p>
            </div>
            ...
            <div className="mt-12 text-center">
              <a href="#formulario"
                ...
                Solicitar análise gratuita para minha empresa <ArrowRight size={15} />
              </a>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end gap-6 mb-10">
              <div className="flex-1">
                ...
                <h2 className="text-[clamp(2rem,4vw,3rem)] font-black text-[#0a1628] leading-[1.05] tracking-tight">
                  Empresas que instalaram<br />não voltaram atrás.
                </h2>
              </div>
              <p className="md:max-w-xs text-gray-500 text-sm leading-relaxed md:mb-1">
            ...
            <div className={`glass-light rounded-3xl overflow-hidden mb-4 transition-all duration-700 ${proofInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
              <div className="bg-[#FFB100] px-7 py-5 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white font-semibold text-sm">Patrick Fernandes</p>
              ...
              <div className="px-7 py-8">
                <blockquote className="text-[#0a1628] text-lg md:text-xl font-medium leading-snug mb-3">
                  "Atendimento impecável, preço competitivo e pontualidade na instalação. Recomendo a Solcenter sem hesitar."
                </blockquote>
            ...
            <div className={`grid md:grid-cols-2 gap-4 transition-all duration-700 delay-100 ${proofInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
              {[
                { name: "Daniel e Neide Wermuth", city: "Santo Cristo, RS", text: "A equipe é dedicada e o retorno que estamos tendo superou as expectativas. Muito satisfeitos com o resultado." },
        ...
        <section className="relative px-6 py-16">
          <div className="max-w-3xl mx-auto">
            <div className="mb-10">
              ...
              <h2 className="text-[clamp(2rem,4vw,3rem)] font-black text-[#0a1628] leading-[1.05] tracking-tight">
                Dúvidas da empresa,<br />respostas diretas.
              </h2>
            </div>
            <div className="flex flex-col gap-3">
              {[
                { q: "Vale a pena para a minha empresa?", a: "Contas empresariais acima de R$ 1.000/mês já têm excelente retorno. Quanto maior o consumo, mais rápido o payback. A análise gratuita mostra o retorno exato para o seu caso." },
                ...
                { q: "Existe financiamento para pessoa jurídica?", a: "Sim. Trabalhamos com linhas de crédito específicas para PJ, com condições especiais. Em muitos casos a parcela é menor do que a economia gerada no primeiro mês." },
        ...
        {/* SUBFOOTER */}
        <SubFooterCTA
          whatsappHref={`${site.whatsappLinkGiovani}?text=Olá, tenho uma empresa e quero uma análise de energia solar empresarial`}
          formHref="#formulario"
        />
